System.register(['angular2/core', 'angular2/common', 'angular2/http', 'rxjs/Rx', 'angular2/router'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            DodajVrstuPicaComponent = (function () {
                function DodajVrstuPicaComponent(builder, http, router) {
                    this.http = http;
                    this.router = router;
                ...
                DodajVrstuPicaComponent.prototype.onDodajVrstuPica = function () {
                    var _this = this;
                    ...
                    this.http.post('http://localhost/IT255-Projekat/php/dodajvrstupicaservice.php', data, { headers: headers })
                        ...
                        _this.router.parent.navigate(['./SveVrstePica']);
                    });
                };
                DodajVrstuPicaComponent = __decorate([
                    core_1.Component({
                ...
                ], DodajVrstuPicaComponent);
                return DodajVrstuPicaComponent;
            }());
            exports_1("DodajVrstuPicaComponent", DodajVrstuPicaComponent);
        }
    }
});
//# sourceMappingURL=dodajvrstupica.component.js.map